...
public class UnitTest1
{
    ...
    public async Task Generate_CreatesImage_WhenInputIsObject()
    {
        ...
        await using var image = await new ContrabandEncoder().GenerateFrame(objectToEncode);
    ...
    public async Task Header_ContainsDataLength()
    {
        ...
        await using var content = await new ContrabandEncoder().GenerateFrame(objectToEncode);
